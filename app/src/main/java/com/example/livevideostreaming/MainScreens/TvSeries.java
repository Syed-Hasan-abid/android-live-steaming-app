...
public class TvSeries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.tvSeriesRecyclerView);
        ...
        {
            AlertDialog.Builder alertDialogue = new AlertDialog.Builder(TvSeries.this);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.search_item: Intent intent = new Intent(TvSeries.this,Search.class);
                        startActivity(intent);
                        break;
                    case R.id.setting_item: Intent intent1 = new Intent(TvSeries.this,Settings.class);
    ...
    {
        mainRecyclerViewAdapter = new MainRecyclerViewAdapter(TvSeries.this,allCategoryList);
        recyclerView.setLayoutManager(new LinearLayoutManager(TvSeries.this));
